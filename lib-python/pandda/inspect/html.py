...
from giant.html import divs, formatters, objects
from giant.html.summary import ImageEmbedder
...
class MakePanddaInspectHtml(object):
    ...
    def get_inspection_progress_bars(
        ...
        block3 = divs.Block(
            ...
            contents=(
                ...
                else [divs.Alert(text="Nothing to show here yet: no fitted ligands")]
            ),
        )
    ...
    def make_output(
        ...
        logger.subheading("Writing output HTML: {}".format(self.output_filename))
        ...
        logger("Output HTML written to {}".format(str(self.output_path)))
