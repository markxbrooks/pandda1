...
from giant.html import divs, formatters
from giant.html.summary import HtmlSummary
...
class MakeMainPanddaHtmlPage(object):
    ...
    def get_body_header(self):
        ...
        d = {
            ...
            "logo_image": HtmlSummary.image(
                pandda.resources.SMALL_LOGO_PATH, embed=True
            ),
            ...
            "citations": [
                format_citation(
                    ...
                    journal=("Nature Communications, 8, 15123."),
                    year=(2017),
                    authors=(
                    ...
                    link=("https://doi.org/10.1038/ncomms15123"),
                ),
                format_citation(
                    title=(
                    ...
                    year=(2017),
                    authors=("Pearce, N. M., Krojer, T., & von Delft, F."),
                    link=("https://doi.org/10.1107/S2059798317003412"),
                ),
            ],
        }
