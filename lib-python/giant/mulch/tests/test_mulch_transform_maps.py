...
def test_GetWarpedMapLoader(five_baz2b_test_datasets_mcd_labelled):
    ...
    input_dataset = five_baz2b_test_datasets_mcd_labelled.datasets[
    ...
    )  # should have deleted internal reference
