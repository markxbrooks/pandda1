...
from .assign_sites import AssignEventsToSites
from .graphs import MakePanddaResultsGraphs
from .html import MakePanddaResultsHtml
from .pymol import MakePymolOutputImages
from .statistics import ExtractPanddaDatasetOutputInfo
from .tables import MakePanddaResultsTables
    ...
    def __init__(
        ...
        if write_graphs is None:
            write_graphs = MakePanddaResultsGraphs(
                output_directory=(output_dir / "graphs"),
            )
