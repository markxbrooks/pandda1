...
from pandda import resources
from pandda.inspect.exceptions import MissingFile
from pandda.inspect.parser import parser
...
from pandda.inspect.events import GetNextModelFile  # noqa: E402
from pandda.inspect.trackers import LigandTracker  # noqa: E402
...
class GetEventHandler(object):
    ...
    def __init__(
        ...
        from pandda.inspect.events import GetEventFiles
    ...
    def __call__(
        ...
        from pandda.inspect.events import Event
...
from pandda.inspect.trackers import EventTracker, SiteTracker  # noqa: E402
...
class MakeNewLigandModal(object):
    ...
    def __init__(
        ...
        from pandda.inspect.ligands import MakeNewLigand
...
class PanddaInspect(object):
    ...
    def __init__(
        ...
        from pandda.inspect.tables import PanddaInspectTableHandler
        ...
        if mode in ["events"]:
            ...
            from pandda.inspect.html import MakePanddaInspectHtml
...
if __name__ == "__main__":
    ...
    try:
        ...
        from pandda.inspect.io import GetPanddaInspectInputOutputFiles
