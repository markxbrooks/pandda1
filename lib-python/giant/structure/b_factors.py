...
from giant.common.geometry import pairwise_distances
...
class CalculateSurroundingsBFactorRatio(object):
    ...
    def __init__(
        ...
        assert self.distance_cutoff > 0.0
    ...
    def __call__(
        ...
        neighbour_atoms = all_atoms.select(neighbour_selection)
        ...
        if neighbour_b != 0.0:
            ...
            b_factor_ratio = selected_b / neighbour_b
    ...
    def find_neighbours(self, selected_atoms, all_atoms):
        ...
        neighbour_selection = within_cutoff.any(axis=0)
