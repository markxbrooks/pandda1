...
class MakePymolOutputImages(object):
    ...
    def __init__(
        ...
        self.output_files = {
            self.output_key_front: str(self.output_directory / self.output_front),
            self.output_key_back: str(self.output_directory / self.output_back),
        }
    ...
    def make_pymol_script(
        ...
        site_counts = {s["site_num"]: 0 for s in site_dicts}
        ...
        pymol_script = str(self.output_directory / self.output_script)
        ...
        try:
            ...
            c.extend_args(
                [
                    ...
                    "-q",
                    "-c",
                    os.path.relpath(script_pml, start=str(self.output_directory)),
                ]
            )
