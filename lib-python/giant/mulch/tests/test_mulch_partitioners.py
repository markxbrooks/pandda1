...
def test_DatasetKeyPartitioner(five_baz2b_test_datasets_mcd):
    ...
    assert (
        partitioned["partition_1"]["BAZ2BA-x430.dimple.pdb"]
        is five_baz2b_test_datasets_mcd.datasets["BAZ2BA-x430.dimple.pdb"]
    )
    assert (
        partitioned["partition_2"]["BAZ2BA-x432.dimple.pdb"]
        is five_baz2b_test_datasets_mcd.datasets["BAZ2BA-x432.dimple.pdb"]
    )
    assert (
        partitioned["partition_3"]["BAZ2BA-x434.dimple.pdb"]
        is five_baz2b_test_datasets_mcd.datasets["BAZ2BA-x434.dimple.pdb"]
    )
