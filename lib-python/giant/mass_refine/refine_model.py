...
class RefinementGenerator(object):
    ...
    def __call__(
        ...
        refine = self.refiner(
            ...
            cif_files=(list(map(str, cif_files)) if cif_files is not None else None),
...
class RefineSingle(object):
    ...
    def __init__(
        ...
        self.refinement_folder = refinement_folder

        # Make temporary output folder
        self.tmp_dir = self.refinement_folder.tmp_dir()
...
class RefineModel(object):
    ...
    def get_refinement_folders(self, model_folder):
        ...
        #
        datasets = self.file_system.datasets.get_all_as_dict()
        #
        refine_folders = {}
        #
