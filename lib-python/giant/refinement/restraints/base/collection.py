from .distance import DistanceRestraintList
from .occupancy import OccupancyRestraintList
...
class RestraintsCollection(object):
    ...
    def __str__(self):
        ...
        s_ = (
            ...
            distance_restraints=str(self.distance_restraints)
            .strip("\n")
            .replace("\n", "\n|\t"),
            occupancy_restraints=str(self.occupancy_restraints)
            .strip("\n")
            .replace("\n", "\n|\t"),
        )
    ...
    def format(self, program="refmac", filepath=None):
        ...
        from ..format import get_restraint_formatter
    ...
    def prune_conflicting(self, method="simple"):
        ...
        if method == "simple":
            ...
            from .prune import PruneConflictingRestraintsSimple
