...
from giant.tests.jiffies import check_files, run_module
...
def test_split_two_states_defaults(resources, tmp_path):
    ...
    output_ground = tmp_path / (input_pdb.stem + "-split-ground-state-ABCDEF.pdb")

    check_files(
        files_list=[p.name for p in tmp_path.glob("*")],
        check_list=[
            input_pdb.name,
...
def test_split_two_states_by_conformer(resources, tmp_path):
    ...
    outputs = [
        tmp_path / (input_pdb.stem + "-split-{}.pdb".format(l)) for l in "ABCDEF"
    ]
...
def test_split_two_states_by_residue_name_ignore_common_false(resources, tmp_path):
    ...
    output_ground = tmp_path / (input_pdb.stem + "-split-ground-state-ABC.pdb")

    output_bound = tmp_path / (input_pdb.stem + "-split-bound-state-DEF.pdb")
...
def test_split_two_states_by_residue_name_output_names(resources, tmp_path):
    ...
    output_ground = tmp_path / (input_pdb.stem + "-split-alpha-ABC.pdb")

    output_bound = tmp_path / (input_pdb.stem + "-split-beta-DEF.pdb")
...
def test_split_three_states_defaults(resources, tmp_path):
    ...
    output_bound = tmp_path / (input_pdb.stem + "-split-bound-state-GHI.pdb")
...
def test_split_three_states_by_residue_name_combine(resources, tmp_path):
    ...
    output_bound = tmp_path / (input_pdb.stem + "-split-bound-state-DEFGHI.pdb")
...
def test_split_three_states_by_conformer_group_1(resources, tmp_path):
    ...
    output_1 = tmp_path / (input_pdb.stem + "-split-ABC.pdb")

    output_2 = tmp_path / (input_pdb.stem + "-split-DEFGHI.pdb")
...
def test_split_three_states_by_conformer_group_2(resources, tmp_path):
    ...
    output_2 = tmp_path / (input_pdb.stem + "-split-DEF.pdb")

    output_3 = tmp_path / (input_pdb.stem + "-split-GHI.pdb")

    output_4 = tmp_path / (input_pdb.stem + "-split-ABCDEF.pdb")

    output_5 = tmp_path / (input_pdb.stem + "-split-DEFGHI.pdb")
