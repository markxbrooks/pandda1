...
COMMON_MOLECULES = WATER_NAMES + ION_NAMES + COMMON_SMALL_MOLECULES
...
AA_MODIFICATIONS_DICT = {
    "CC(NCCCC[C@@H](C=O)N)=O": ("K(ac)", "K(Ac)", "{KAc}", "Kac"),
...
MISC_SMILES_DICT = {
    "C[C@@H](OC1CC(C2CNN(C)C2)CNC1N)[C@@H]1C(Cl)CCC(F)C1Cl": ("HEME",),
}
