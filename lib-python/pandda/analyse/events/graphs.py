...
from pandda.graphs import PanddaDatasetPlotter
...
class MakeBdcEstimationGraph(PanddaDatasetPlotter):
    ...
    def __call__(self, dataset, event_num, *args, **kwargs):
        ...
        fig = self.plot(dataset=dataset, *args, **kwargs)
    ...
    def plot(
        self, event_fractions, event_correlations, global_correlations, *args, **kwargs
    ):
        ...
        a2.set_ylim((min(diff_values) - 0.2, max(diff_values) + 0.2))
