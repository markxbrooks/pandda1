...
from .output import GetPanddaStatisticalModelOutputter
...
class PanddaStatisticalModel(object):
    ...
    def __str__(self):
        ...
        s_ = (
            ...
            name=self.name,
            mu_map_string=(mu_map_string.strip().replace("\n", "\n|\t")),
            sigma_adjusted_string=(
    ...
    def get_z_map(
        ...
        if z_map_type == "none":
            ...
            norm_map = np.sqrt((self.sigma_adjusted_map_data**2.0) + (unc**2.0))
...
class GetPanddaStatisticalModelFitter(object):
    ...
    def __call__(self):
        ...
        from pandda.analyse.statistical_model.fit import PanddaStatisticalModelFitter
