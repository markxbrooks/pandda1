...
def strip_pdb_to_string(input_pdb, remove_ter=False, remove_end=False):
    ...
    for line in pdb_lines:
        if remove_ter and (line[0:3] == "TER"):
            pass
        elif remove_end and (line[0:3] == "END"):
            pass
        else:
...
def strip_pdb_to_input(input_pdb, remove_ter=False, remove_end=False):
    ...
    stripped = strip_pdb_to_string(
        input_pdb=input_pdb, remove_ter=remove_ter, remove_end=remove_end
    )
