...
def test_ExtractDatasetStatistics(five_baz2b_test_datasets_mcd):
    ...
    assert dataframe.loc["BAZ2BA-x434.dimple.pdb"]["unit_cell"] == (
        81.403,
        96.831,
        57.784,
        90,
...
def test_ClassifyDatasetStatistics(five_baz2b_test_datasets_mcd):
    ...
    assert dataframe.loc["BAZ2BA-x434.dimple.pdb"]["r_free"] == pytest.approx(0.20442)
    assert dataframe.loc["BAZ2BA-x434.dimple.pdb"]["r_free_test"] == pytest.approx(
        -1.321304
    )
...
def test_ExtractAndClassifyDatasetStatistics(five_baz2b_test_datasets_mcd):
    ...
    assert statistics_info.statistics.data["BAZ2BA-x434.dimple.pdb"][
        "r_free"
    ] == pytest.approx(0.20442)

    assert statistics_info.dataframe.loc["BAZ2BA-x434.dimple.pdb"][
        "r_free"
    ] == pytest.approx(0.20442)
    assert statistics_info.dataframe.loc["BAZ2BA-x434.dimple.pdb"][
        "r_free_test"
    ] == pytest.approx(-1.321304)

    assert statistics_info.classifications["test_partition"] == [
        "BAZ2BA-x432.dimple.pdb",
        "BAZ2BA-x434.dimple.pdb",
    ]
...
def test_ExtractAndClassifyScalingStatistics(five_baz2b_test_datasets_mcd_labelled):
    ...
    reference_dataset = five_baz2b_test_datasets_mcd_labelled.datasets[
        "BAZ2BA-x434.dimple.pdb"
    ]
    ...
    assert statistics_info.dataframe.loc["BAZ2BA-x430.dimple.pdb"][
        "b_factor_scaling"
    ] == pytest.approx(-0.001)
    assert statistics_info.dataframe.loc["BAZ2BA-x431.dimple.pdb"][
        "b_factor_scaling"
    ] == pytest.approx(-0.293)
    assert statistics_info.dataframe.loc["BAZ2BA-x432.dimple.pdb"][
        "b_factor_scaling"
    ] == pytest.approx(0.244)
    assert statistics_info.dataframe.loc["BAZ2BA-x433.dimple.pdb"][
        "b_factor_scaling"
    ] == pytest.approx(-0.197)
    assert statistics_info.dataframe.loc["BAZ2BA-x434.dimple.pdb"][
        "b_factor_scaling"
    ...
    assert statistics_info.dataframe.loc["BAZ2BA-x430.dimple.pdb"][
        "scaled_wilson_rmsd"
    ] == pytest.approx(4015.332)
    assert statistics_info.dataframe.loc["BAZ2BA-x431.dimple.pdb"][
        "scaled_wilson_rmsd"
    ] == pytest.approx(6025.885)
    assert statistics_info.dataframe.loc["BAZ2BA-x432.dimple.pdb"][
        "scaled_wilson_rmsd"
    ] == pytest.approx(4889.924)
    assert statistics_info.dataframe.loc["BAZ2BA-x433.dimple.pdb"][
        "scaled_wilson_rmsd"
    ] == pytest.approx(2953.761)
    assert statistics_info.dataframe.loc["BAZ2BA-x434.dimple.pdb"][
        "scaled_wilson_rmsd"
    ] == pytest.approx(0.000)
    ...
    ] == pytest.approx(4012.384)
    assert statistics_info.dataframe.loc["BAZ2BA-x431.dimple.pdb"][
        "unscaled_wilson_rmsd"
    ] == pytest.approx(4546.437)
    assert statistics_info.dataframe.loc["BAZ2BA-x432.dimple.pdb"][
        "unscaled_wilson_rmsd"
    ] == pytest.approx(7667.431)
    assert statistics_info.dataframe.loc["BAZ2BA-x433.dimple.pdb"][
        "unscaled_wilson_rmsd"
    ] == pytest.approx(3695.816)
    assert statistics_info.dataframe.loc["BAZ2BA-x434.dimple.pdb"][
        "unscaled_wilson_rmsd"
    ] == pytest.approx(0.000)
    ...
    assert statistics_info.dataframe.loc["BAZ2BA-x430.dimple.pdb"][
        "scaled_wilson_rmsd_test"
    ] == pytest.approx(0.213405, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x431.dimple.pdb"][
        "scaled_wilson_rmsd_test"
    ] == pytest.approx(1.192213, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x432.dimple.pdb"][
        "scaled_wilson_rmsd_test"
    ] == pytest.approx(0.639187, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x433.dimple.pdb"][
        "scaled_wilson_rmsd_test"
    ] == pytest.approx(-0.303405, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x434.dimple.pdb"][
        "scaled_wilson_rmsd_test"
    ] == pytest.approx(-1.741400, abs=1e-3)

    assert statistics_info.dataframe.loc["BAZ2BA-x430.dimple.pdb"][
        "scaled_wilson_rmsd_high_test"
    ] == pytest.approx(0.205981, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x431.dimple.pdb"][
        "scaled_wilson_rmsd_high_test"
    ] == pytest.approx(1.199517, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x432.dimple.pdb"][
        "scaled_wilson_rmsd_high_test"
    ] == pytest.approx(0.639640, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x433.dimple.pdb"][
        "scaled_wilson_rmsd_high_test"
    ] == pytest.approx(-0.309021, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x434.dimple.pdb"][
        "scaled_wilson_rmsd_high_test"
    ] == pytest.approx(-1.736116, abs=1e-3)

    assert statistics_info.dataframe.loc["BAZ2BA-x430.dimple.pdb"][
        "scaled_wilson_rmsd_low_test"
    ] == pytest.approx(0.962035, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x431.dimple.pdb"][
        "scaled_wilson_rmsd_low_test"
    ] == pytest.approx(0.039969, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x432.dimple.pdb"][
        "scaled_wilson_rmsd_low_test"
    ] == pytest.approx(0.578210, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x433.dimple.pdb"][
        "scaled_wilson_rmsd_low_test"
    ] == pytest.approx(0.325694, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x434.dimple.pdb"][
        "scaled_wilson_rmsd_low_test"
    ] == pytest.approx(-1.905908, abs=1e-3)

    assert statistics_info.dataframe.loc["BAZ2BA-x430.dimple.pdb"][
        "scaled_wilson_ln_rmsd_test"
    ] == pytest.approx(0.747113, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x431.dimple.pdb"][
        "scaled_wilson_ln_rmsd_test"
    ] == pytest.approx(0.747113, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x432.dimple.pdb"][
        "scaled_wilson_ln_rmsd_test"
    ] == pytest.approx(0.556523, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x433.dimple.pdb"][
        "scaled_wilson_ln_rmsd_test"
    ] == pytest.approx(-0.167719, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x434.dimple.pdb"][
        "scaled_wilson_ln_rmsd_test"
    ] == pytest.approx(-1.883029, abs=1e-3)

    assert statistics_info.dataframe.loc["BAZ2BA-x430.dimple.pdb"][
        "scaled_wilson_ln_dev_test"
    ] == pytest.approx(0.559273, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x431.dimple.pdb"][
        "scaled_wilson_ln_dev_test"
    ] == pytest.approx(0.744385, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x432.dimple.pdb"][
        "scaled_wilson_ln_dev_test"
    ] == pytest.approx(0.670450, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x433.dimple.pdb"][
        "scaled_wilson_ln_dev_test"
    ] == pytest.approx(-0.055644, abs=1e-3)
    assert statistics_info.dataframe.loc["BAZ2BA-x434.dimple.pdb"][
        "scaled_wilson_ln_dev_test"
    ] == pytest.approx(-1.918464, abs=1e-3)
