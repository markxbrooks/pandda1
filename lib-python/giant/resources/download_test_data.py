...
class ZenodoDataset(Dataset):
    def __init__(self, id, type, zenodo_id, log=None):
        ...
        self.data_url = self.base_url + "wrappers/data.zip"
        self.data_dir = None
    ...
    def download(self, output_directory):
        ...
        assert os.path.join(
            self.data_dir
        ), "Data directory should have been created by this process!"
...
zenodo_dataset_information = [
    ("BAZ2B", "fragment screen", 48768),
