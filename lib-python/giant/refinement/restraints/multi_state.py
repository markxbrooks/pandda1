...
from .base import RestraintsCollection
from .conformers import MakeDuplicateConformerRestraints, MakeIntraConformerRestraints
from .occupancy import MakeMultiStateOccupancyRestraints, MakeSimpleOccupancyRestraints
...
class MakeMultiStateRestraints(object):
    ...
    def __call__(self, hierarchy):
        ...
        for restraint_maker in [
            ...
            logger.subheading("Making restraints for {}".format(restraint_maker.name))
